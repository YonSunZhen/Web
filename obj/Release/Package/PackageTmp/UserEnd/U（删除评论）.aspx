<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="U（删除评论）.aspx.cs" Inherits="WebApp.后台管理_普通成员_.U_删除评论_" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="CommentID" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="Vertical" PageSize="6" Width="500px">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:cnPc %>" DeleteCommand="DELETE FROM [Comment] WHERE [CommentID] = @CommentID" InsertCommand="INSERT INTO [Comment] ([TopicID], [TopicName], [UserName], [CommentContent]) VALUES (@TopicID, @TopicName, @UserName, @CommentContent)" SelectCommand="SELECT * FROM [Comment] WHERE ([UserName] = @UserName)" UpdateCommand="UPDATE [Comment] SET [TopicID] = @TopicID, [TopicName] = @TopicName, [UserName] = @UserName, [CommentContent] = @CommentContent WHERE [CommentID] = @CommentID">
        <DeleteParameters>
